...
class Page
{
    ...
    public function getHeader()
    {
        ...
        if($_GET['print'])
            $this->header .='<link type="text/css" rel="stylesheet" href="webskins/skins/news/css/style.css?ver='.time().'" />';
        else
            $this->header .='<link type="text/css" rel="stylesheet" href="webskins/skins/news/css/responsive.css?ver='.time().'" />';    

...
define('ROOT_URL',PROTOCOL.$_SERVER['HTTP_HOST'].DS);
define('IMAGE_URL',PROTOCOL.$_SERVER['HTTP_HOST'].DS);
define('STATIC_URL',PROTOCOL.$_SERVER['HTTP_HOST'].DS);
define('DATA_URL',PROTOCOL.$_SERVER['HTTP_HOST'].DS);
